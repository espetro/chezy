...
export type DemoConfig = {
  ...
  width: 1920;
  height: 1080;
  // `voice` is passed to `pocket-tts --voice`: a built-in voice name
  ...
  // file regenerates every segment.
...
export const demoConfig: DemoConfig = {
  ...
  voice: { engine: "pocket-tts", voice: "voices/chezy-narrator.safetensors" },
