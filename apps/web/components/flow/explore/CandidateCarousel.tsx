...
export const CandidateCarousel = ({ listings, label }: CandidateCarouselProps) => {
  ...
  if (total === 0) {
    return (
      <p className="rounded-cards bg-snow px-6 py-8 shadow-sm text-center text-[14px] text-fog">
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex size-10 items-center justify-center rounded-full border border-mist bg-snow text-graphite transition-opacity hover:border-iron disabled:cursor-not-allowed disabled:opacity-30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-obsidian"
          >
            <ChevronLeft size={18} />
          </button>
          <button
