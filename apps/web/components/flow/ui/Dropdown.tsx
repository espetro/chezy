...
const triggerClass = (isOpen: boolean, compact: boolean) =>
  cn(
    "flex h-11 w-full items-center gap-2 rounded-inputs border border-cloud bg-snow text-label-md text-obsidian transition-colors duration-200 hover:bg-card-subtle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-obsidian",
