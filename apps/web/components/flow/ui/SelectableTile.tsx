...
export const FlowSelectableTile = ({ label, icon, selected, onToggle }: SelectableTileProps) => (
  <button
    ...
    onClick={onToggle}
    className="flex items-center justify-between gap-2 rounded-[18px] bg-paper p-3 text-left transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-obsidian focus-visible:outline-none"
  >
