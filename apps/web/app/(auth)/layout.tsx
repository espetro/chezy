...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-[100dvh] w-full flex-col bg-paper font-flow text-obsidian">
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col px-4 py-4 sm:px-6 sm:py-8">
        <Link
